...
def build_driver(songtab_addr, sfxtab_addr):
    ...
    a.mov_dp_imm(TMP, 200)      # bounded retry: give up after 200 iterations
    a.label("start_song_envx_wait")
    a.mov_a_dp(0xF3)
    a.bne("start_song_envx_next")
    a.mov_a_dp(0xF2)
    a.clrc()
    a.adc_a_imm(0x10)
    a.mov_dp_a(0xF2)
    ...
    a.bra("start_song_envx_done")
    a.label("start_song_envx_next")
    a.dec_dp(TMP)
    a.bne("start_song_envx_wait")
    a.label("start_song_envx_done")
    a.dsp(0x5C, 0x00)
    a.mov_x_imm(0)
    a.label("svol")
    a.mov_a_absx("chvoice")
    ...
    a.bra("stop_music_envx_done")
    a.label("stop_music_envx_next")
    a.dec_dp(TMP)
    a.bne("stop_music_envx_wait")
    a.label("stop_music_envx_done")
    a.dsp(0x5C, 0x00)
    a.ret()
